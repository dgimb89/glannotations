...
glat::FontAnnotation::FontAnnotation(const globjects::ref_ptr<glat::AbstractState>& initialState, std::string text, std::string fontName, const glat::RendererFactory& factory /*= RendererFactory()*/)
