...
std::shared_ptr<globjects::Texture> glat::TextureManager::getTexture(std::string fileName) {
...
glat::ManagedTexture::ManagedTexture(gl::GLenum target /*= GL_TEXTURE_2D*/) : globjects::Texture(target) {
}
